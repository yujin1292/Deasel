...
class ZoomView(context: Context) : FrameLayout(context) {
    ...
    private var touchLastX: Float = 0.toFloat()
    private var touchLastY: Float = 0.toFloat()
    private var startd: Float = 0.toFloat()
    var pinching: Boolean = false
    private var lastd: Float = 0.toFloat()
    private var lastdx1: Float = 0.toFloat()
    private var lastdy1: Float = 0.toFloat()
    private var lastdx2: Float = 0.toFloat()
    private var lastdy2: Float = 0.toFloat()
